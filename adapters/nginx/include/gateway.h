...
char *ngx_http_gateway_merge_traffic_shaper(ngx_conf_t *cf, ngx_http_gateway_conf_t *prev, ngx_http_gateway_conf_t *conf);
ngx_int_t ngx_http_gateway_eval_traffic_shaper(ngx_http_request_t *r, ngx_http_gateway_conf_t *conf, ngx_str_t host);

/* Extension: Request Size Limit */
char *ngx_http_gateway_merge_request_size_limit(ngx_conf_t *cf, ngx_http_gateway_conf_t *prev, ngx_http_gateway_conf_t *conf);
ngx_int_t ngx_http_gateway_eval_request_size_limit(ngx_http_request_t *r, ngx_http_gateway_conf_t *conf, ngx_str_t host);
