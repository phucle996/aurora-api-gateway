...
const (
	HeartbeatService_SendHeartbeat_FullMethodName = "/aurora.sync.v1.HeartbeatService/SendHeartbeat"
)
...
var HeartbeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aurora.sync.v1.HeartbeatService",
	...
	Metadata: "sync/v1/heartbeat.proto",
}
