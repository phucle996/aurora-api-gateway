...
// AccessHandler provides HTTP transport endpoints for IP & Access Control.
...
func (h *AccessHandler) Change(c *gin.Context) {
	...
	out, err := h.Service.Change(c.Request.Context(), cmd)
	if err != nil {
...
func (h *AccessHandler) Read(c *gin.Context) {
	...
	out, err := h.Service.Read(c.Request.Context(), q)
	if err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
...
func (h *AccessHandler) Status(c *gin.Context) {
	out, err := h.Service.Status(c.Request.Context())
	if err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
...
func (h *AccessHandler) Desired(c *gin.Context) {
	out, err := h.Service.Desired(c.Request.Context(), entity.AccessSyncQuery{NodeID: c.Param("node")})
	if err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
...
func (h *AccessHandler) Report(c *gin.Context) {
	...
	if err := h.Service.Report(c.Request.Context(), cmd); err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
		case errors.Is(err, taxonomy.ErrAccessInvalid):
...
func (h *AccessHandler) Match(c *gin.Context) {
	...
	if err := h.Service.Match(c.Request.Context(), cmd); err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
		case errors.Is(err, taxonomy.ErrAccessInvalid):
...
func (h *AccessHandler) Activity(c *gin.Context) {
	out, err := h.Service.Activity(c.Request.Context())
	if err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
...
func (h *AccessHandler) Catalog(c *gin.Context) {
	out, err := h.Service.Catalog(c.Request.Context())
	if err != nil {
		status := http.StatusInternalServerError
		message := "access storage unavailable"
		switch {
