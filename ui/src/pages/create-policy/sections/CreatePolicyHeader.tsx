...
export function CreatePolicyHeader({ isEditing }: CreatePolicyHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200 dark:border-[#152030]">
      ...
      <Link
        to="/policies"
        className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-white dark:bg-[#0B1320] hover:bg-slate-50 dark:hover:bg-[#152030] border border-slate-200 dark:border-[#1C293D] text-slate-700 dark:text-slate-300 text-xs font-mono transition-colors rounded-sm shadow-xs shrink-0 self-start sm:self-auto"
      >
