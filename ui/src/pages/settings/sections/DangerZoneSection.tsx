...
export function DangerZoneSection() {
  ...
  return (
    <>
      <div className="bg-[#0B1320] border border-rose-950/60 p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-md bg-[#0B1320] border border-rose-500/60 shadow-2xl flex flex-col">
            ...
            <form onSubmit={handleReset} className="p-5 space-y-4 font-mono text-xs">
              ...
              <div>
                <label className="block text-slate-400 mb-1 text-[11px]">
                  Type <span className="text-rose-400 font-bold">RESET-AURORA</span> to confirm:
                </label>
                <input
                  type="text"
                  value={confirmInput}
                  ...
                  className="w-full bg-[#0E1726] border border-[#1C293D] px-3 py-2 text-white font-mono focus:outline-none focus:border-rose-500"
                />
              </div>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-[#152030]">
                <button
                  type="button"
                  onClick={() => setShowConfirmModal(false)}
                  className="px-4 py-2 bg-[#0E1726] border border-[#1C293D] text-slate-300 hover:text-white"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-rose-600 hover:bg-rose-500 disabled:opacity-40 border border-rose-500 text-white font-semibold"
                >
