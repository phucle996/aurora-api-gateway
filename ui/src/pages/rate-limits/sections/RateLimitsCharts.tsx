    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 font-sans">
      ...
      <div className="bg-card border border-border p-4 space-y-4 shadow-sm">
        ...
        <div className="flex gap-3 h-44 pt-2">
          {/* Y Axis Labels */}
          <div className="flex flex-col justify-between text-[10px] text-muted-foreground text-right w-9 select-none">
            <span>2,000</span>
            <span>1,500</span>
            <span>1,000</span>
            <span>500</span>
          ...
          <div className="flex-1 flex flex-col justify-end">
            <div className="h-full flex items-end justify-between gap-1 border-b border-l border-border px-1 pb-0.5">
              {hourlyData.map((item, idx) => (
                <div
                  key={idx}
                  className="flex-1 bg-primary/70 hover:bg-primary transition-colors rounded-t-[1px]"
            ...
            {/* X Axis Time Labels */}
            <div className="flex justify-between text-[10px] text-muted-foreground pt-1.5 px-1 select-none">
              <span>00:00</span>
              <span>04:00</span>
              <span>08:00</span>
              <span>12:00</span>
        ...
        <div className="space-y-3.5 pt-2">
          {topEndpoints.map((ep) => (
            <div key={ep.path} className="flex items-center gap-3 text-xs">
              <span className="w-28 text-muted-foreground truncate text-[11px] font-mono">
                {ep.path}
              </span>

              {/* Progress track */}
              <div className="flex-1 bg-muted border border-border h-2 rounded-sm overflow-hidden">
                <div
